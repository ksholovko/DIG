  ...
  return storedBooks
    .map(
      ({
        ...
        }" target="_blank"><img style="height:16px " src="${amazon}" class="darkFilter" alt="Amazon"/></a>
  </li>
  <li> 
    <a href="${
      buy_links.filter(({ name }) => {
    ...
    }" target="_blank"><img style="height:16px " src="${applebooks}" alt="Apple Books"/></a>
  </li>
  </ul>
  </div>
  </div>
...
// import bookIsEmptyMob from '../images/IMG_9606 1.png';
// const listBooksEl = document.querySelector('.js-list-books');

// function isEmpty() {
//   listBooksEl.innerHTML = `<div class="empty-message" style="display: none;">
//   <img src="${bookIsEmptyMob}" alt="Empty Image" />
...
//   }
// }
// // Оновити повідомлення при завантаженні сторінки
// updateEmptyMessage();

// // Оновити повідомлення після видалення книги
// deleteButtons.forEach(button => {
//   button.addEventListener('click', event => {
//     const bookId = event.target.dataset.id;
//     deleteBook(bookId); // Викликати функцію видалення книги
//     updateEmptyMessage(); // Оновити повідомлення
//   });
// });